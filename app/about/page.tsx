      ...
      <div className="relative z-10 mx-auto max-w-content px-5 py-16 sm:px-10 md:py-24">
        ...
        <div className="flex flex-col gap-10 border-b border-white/10 py-16 md:flex-row md:gap-20 md:py-20">
          ...
          <div className="min-w-0 flex-1 border-l-2 border-blue pl-8">
            <p className="max-w-[62ch] text-[18px] leading-relaxed text-white sm:text-[19px]">
              Vorexa was founded by Mornay Walters, who leads the group&rsquo;s product
              direction. His background is in operational management within complex, multi site
              environments, where the gap between available information and usable information
              is a daily constraint. Vorexa&rsquo;s product portfolio is shaped directly by that
              experience.
            </p>
          </div>
        </div>
          ...
          <div className="min-w-0 flex-1">
            <ol className="flex flex-col">
              {howWeWork.map((text, i) => (
                <li
                  key={text}
                  className="flex items-center gap-6 border-t border-white/10 py-5 first:border-t-0"
                >
                  ...
                  <span className="font-heading text-[19px] font-medium leading-snug text-white sm:text-[22px]">
                    {text}
                  </span>
                </li>
              ))}
